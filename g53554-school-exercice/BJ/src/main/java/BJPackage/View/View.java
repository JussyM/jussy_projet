...
public class View implements ViewInterface {
     ...
     */
    @Override
    public void printWinnerBet(int bet) {
        System.out.println(TerminalColor.toBlue("Le gagnant shop une mise de: " + bet)+" EURO");
    }
