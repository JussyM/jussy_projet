...
public class MiddleVBox extends VBox {
    ...
    private void createUpperLabel() {
        ...
        upperLabel.setText("DECK " + "NBCARD: " + deck.nbCard());
    ...
    /**
     * create keep and not keep label that contain a message that describe each button below
     */
    ...
    /**
     * it assemble all the element for the popUp to be well done and fixed up and show
     *
    ...
    public void updateDeckLabel() {
        var upperLabel = (Label) nodeList.get(0);
        upperLabel.setText("DECK " + "PITCHED: " + deck.nbCard());
