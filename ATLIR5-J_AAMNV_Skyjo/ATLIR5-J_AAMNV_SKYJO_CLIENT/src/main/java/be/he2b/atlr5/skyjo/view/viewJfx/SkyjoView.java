...
import be.he2b.atlr5.skyjo.view.viewJfx.fxmlControllers.UserNameInterface;
...
public class SkyjoView implements Observer {
    ...
    /**
     * An event filter will be add when the game will be over to lock all the
     * click of mouse
     */
    ...
    public void update(Observable observable, Object o) {
        ...
        switch (srvMsg.getType()) {
            ...
            case USER_CREATED -> {
                client.setUser((User) srvMsg.getMsg());
                showUsersInformation(client);
            }
            case PLAYER_INFO ->
     ...
     */
    private void showUsersInformation(ClientConnexion client) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/userInfo.fxml"));
        var infoController = new UserInfo(client.getUser());
